...
public class SplashScreen extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        curvesPanel1 = new view.CurvesPanel();
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    doTask("Đang chạy 10/100 ...", 20);
                    doTask("Đang chạy 20/100 ...", 30);
                    doTask("Đang chạy 30/100 ...", 40);
                    doTask("Đang chạy 40/100 ...", 50);
                    doTask("Đang chạy 50/100 ...", 60);
                    doTask("Đang chạy 60/100 ...", 70);
                    doTask("Đang chạy 70/100 ...", 80);
                    doTask("Đang chạy 80/100 ...", 90);
                    doTask("Đang chạy 90/100 ...", 100);
                    doTask("Done ...", 100);
                    dispose();
        		
                    curvesPanel1.stop();    //  To Stop animation
                	ViewBatDau view  = new ViewBatDau();
    ...
    private view.CurvesPanel curvesPanel1;
