...
<%--&lt;%&ndash;            <h1 style="font-size: 20px;color: #abad0a;margin:20px ;">THÔNG TIN NHẬN HÀNG</h1>&ndash;%&gt;--%>
<%--&lt;%&ndash;            <table class="thongtinnhanhang">&ndash;%&gt;--%>
<%--&lt;%&ndash;                <tbody id="thongtinnhanhang">&ndash;%&gt;--%>
<%--&lt;%&ndash;                <tr>&ndash;%&gt;--%>
<%--&lt;%&ndash;                    <td width="20%" style="color: #1d1c1c;font-weight: 900;">Họ tên</td>&ndash;%&gt;--%>
<%--&lt;%&ndash;                    <td><input type="text" name="hoten" style="color: black;"></td>&ndash;%&gt;--%>
<%--&lt;%&ndash;                </tr>&ndash;%&gt;--%>
<%--&lt;%&ndash;                <tr>&ndash;%&gt;--%>
<%--&lt;%&ndash;                    <td  style="color: #1d1c1c;font-weight: 900;">Địa chỉ</td>&ndash;%&gt;--%>
<%--&lt;%&ndash;                    <td><input type="text" name="diachi"style="color: black;"></td>&ndash;%&gt;--%>
<%--&lt;%&ndash;                </tr>&ndash;%&gt;--%>
<%--&lt;%&ndash;                <tr>&ndash;%&gt;--%>
<%--&lt;%&ndash;                    <td  style="color: #1d1c1c;font-weight: 900;">Điện thoại</td>&ndash;%&gt;--%>
...
<%--&lt;%&ndash;            <h1  style="color: #1d1c1c;font-weight: 900;margin: 20px;"> GIỎ HÀNG</h1>&ndash;%&gt;--%>
...
<%--&lt;%&ndash;                    <th>Hình</th>&ndash;%&gt;--%>
<%--&lt;%&ndash;                    <th>Tên sản phẩm</th>&ndash;%&gt;--%>
<%--&lt;%&ndash;                    <th>Đơn giá</th>&ndash;%&gt;--%>
<%--&lt;%&ndash;                    <th>Số lượng</th>&ndash;%&gt;--%>
<%--&lt;%&ndash;                    <th>Thành tiền ($)</th>&ndash;%&gt;--%>
...
<%--&lt;%&ndash;&lt;%&ndash;                        <td><button   style="border-radius: 5px;" class="remove-product" pid="${product.id}">Xóa</button></td>&ndash;%&gt;&ndash;%&gt;--%>
...
<%--&lt;%&ndash;                    <th colspan="6">Tổng đơn hàng</th>&ndash;%&gt;--%>
<%--&lt;%&ndash;                    <th>&ndash;%&gt;--%>
...
<%--&lt;%&ndash;                        <a class="thanhtoan "  href="#my-dialog" style="text-decoration: none;margin-left: 10px;color: #4CAF50">Thanh toán </a>&ndash;%&gt;--%>
<%--&lt;%&ndash;                    </button>&ndash;%&gt;--%>
<%--&lt;%&ndash;                </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;        </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;        <!-- <div class="row mb">&ndash;%&gt;--%>
<%--&lt;%&ndash;            <button class="dongy" onclick="dongydathang()">ĐỒNG Ý ĐẶT HÀNG</button>&ndash;%&gt;--%>
<%--&lt;%&ndash;        </div> -->&ndash;%&gt;--%>
<%--&lt;%&ndash;    </div>&ndash;%&gt;--%>
...
<%--                },--%>
<%--                error:function (data){--%>
<%--                    alert("Hiện tại mặt hàng này không đủ cung cấp !")--%>
<%--                }--%>
<%--            });--%>
