                    ...
                    <div class="container">
                        <div class="table-wrapper">
                            ...
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                <c:forEach var="tra" items="${listnew}">
                                    <tr>
                                        <td>
                                    <span class="custom-checkbox">
                                        ...
                                        <td>
                                            ...
                                            <a href="deleteNewControl?newid=${tra.newid}" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                        </td>
                                    </tr>
                                </c:forEach>
                                </tbody>
                            ...
                            <div class="modal-content">
                                <form action="add_new" method="post">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            <label>Image</label>
                                            <input name="derection" type="text" class="form-control" required>
                                        </div>
                                                                                <div class="form-group">
                                                                                    <label>Price</label>
